...
public abstract class AMPBuilder {
    ...
    /**
     * build from a LinkedhashMap containing a key value where a key is well linked to a value as byte array.
     *
     * Example:
     *
     * key : _hash value : 0x0000à0000000000000 (as byte array)
     *
     * @param map The fragments values.
     */
    protected final void build(final LinkedHashMap<String, byte[]> map) {
        message = new byte[0];
        /*
     ...
     *
     * @param key The key
     * @param bs the raw value
     */
    private void addPair(final String key, final byte[] bs) {
        int offSet = 0;
        //lenght of the key
