...
public interface AMPResponseCallback {
    ...
    /**
     * Called when results are available if you are running an interface, you should change it here.
     *
     * @param results A list of results found
     */
    void callbackSuccess(ArrayList<Searchable> results);
     ...
     */
    void callbackFailure(String failureMessage);
